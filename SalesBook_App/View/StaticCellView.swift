...
class StaticTableViewCell: UITableViewCell {
    ...
    fileprivate let container: UIView = {
        ...
        view.backgroundColor = UIColor(red: 160/255, green: 170/255, blue: 190/255, alpha: 0.8)
...
private extension StaticTableViewCell {
    func setupSubviews() {
        ...
        date.leadingAnchor.constraint(equalTo: container.leadingAnchor, constant: 4).isActive = true
        date.trailingAnchor.constraint(equalTo: container.trailingAnchor, constant: -4).isActive = true
        date.heightAnchor.constraint(equalToConstant: 60).isActive = true
